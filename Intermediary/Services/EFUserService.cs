...
public class EfUserService : IUserService
{
    ...
    public async Task<ApiResponse<PaginatedResponse<List<UserDto>>>> GetAllUsers(int pageNumber, int pageSize)
    {
        ...
        PaginatedResponse<List<UserDto>> paginatedResponse =
            new PaginatedResponse<List<UserDto>>(userDtos, pageNumber, pageSize, totalCount);
        return new ApiResponse<PaginatedResponse<List<UserDto>>>(true, "Users retrieved successfully",
            paginatedResponse);
    }
